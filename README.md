...
| 이름           | 포지션       | 담당 역할                                                                                                                                                     |
| :----------- | :-------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **조상진** (팀장) | FullStack | • JSP → Thymeleaf 변경<br>• Oracle → MySQL 변경<br>• 관리자 페이지 담당<br>• 관리자 공지사항, FAQ, 마이페이지 기능 구현<br>• 테이블 정의서 작성<br>• 전반적인 문서 작업                               |
| **주석우**      | FullStack | • 챗봇 사이트 최적화<br>• 상담원 채팅방<br>• 문의페이지 담당<br>• 고객센터 백·프론트 기능 구현<br>• 메인페이지 프론트 설계                                                                           |
...
| **최예성**      | FullStack | • 공지사항, FAQ 기능 구현<br>• 업무 흐름도, 메뉴 구조도, ERD, 테이블 명세서 작성<br>• CSV, PDF 파일 다운로드<br>• 문서 작업                                                                   |
