...
<div class="container">
    ...
    <div class="info-line">
        <div><strong>작성자</strong> | ${content_view.boardName}</div>
        <div><strong>조회수</strong> | ${content_view.boardHit}</div>
    </div>

    <hr>

    <div class="info-line">
        <div><strong>작성일</strong> | ${content_view.boardDate}</div>
    </div>
    ...
    <div class="uploadResult">
        <ul></ul>
        <div class="file-check" style="display:none; color:#666; text-align:left; font-size:15px;">
            첨부된 파일이 없습니다.
        </div>
    </div>
    ...
    <div class="actions">
		<a href="list?pageNum=${pageNum}&amount=${amount}">목록으로</a>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $.getJSON("/getFileList", {boardNo: boardNo}, function (arr) {
            ...
            if (arr.length === 0) $(".file-check").show();
        });
